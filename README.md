...
> A production-grade, full-stack College ERP system built to digitize campus operations — attendance, marks, fees, and administration.
...
- Node.js 18+ and npm
- MySQL 8
- Maven (or use the included Maven in `backend/apache-maven-3.9.6`)
